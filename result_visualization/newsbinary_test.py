# I build this file be cause Newsbinary dataset has some issue, so I will teset which dataset should I use
# The reason is because I use the major_time instead of the major max time
import pandas as pd
...
# Set file path
file_path = '/Users/shaozishan/Desktop/new_outputs/newsbinary_all/caksvm_data_newsbinary_poly_barrier.csv'
...
max_major_time_s_0 = [df[(df['num_process'] == num_process) & (df['s'] == 0)]['major_time'].iloc[0] for num_process in unique_num_processes]
