...
file = '/Users/shaozishan/Desktop/new_outputs/bdcd/para_ca_data_duke_poly.csv'
...
if "newsbinary" in file:
    filename = 'Cabdcd_Newsbinary_{}_{}_General.png'.format(kernel_type,blksize)
if "duke" in file:
    filename = 'Cabdcd_Duke_{}_{}_General.png'.format(kernel_type,blksize)
if "colon" in file:
    filename = 'Cabdcd_Colon_{}_{}_General.png'.format(kernel_type,blksize)
if "leu" in file:
    filename = 'Cabdcd_Leu_{}_{}_General.png'.format(kernel_type,blksize)
...
unique_blksize = sorted(df['blksize'].unique())

print(unique_blksize)
print(unique_num_processes)
...
# Show the plot
#plt.title(f'Block Dual Coordinate Descent Strong Scaling | Newsbinary, {{}}, blksize = {{}}'.format(kernel_type,blksize))
...
directory = '/Users/shaozishan/Desktop/new_outputs/bdcd/general_plot'
