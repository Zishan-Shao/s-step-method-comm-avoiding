...
files = ['/Users/shaozishan/Desktop/new_outputs/final_plots/Data/caksvm_data_colon_gauss_barrier.csv',
         '/Users/shaozishan/Desktop/new_outputs/final_plots/Data/caksvm_data_colon_linear_barrier.csv',
         '/Users/shaozishan/Desktop/new_outputs/final_plots/Data/caksvm_data_colon_poly_barrier.csv']
    
    
    #'/Users/shaozishan/Desktop/new_outputs/modified/news/caksvm_data_duke_gauss_barrier.csv',
    #     '/Users/shaozishan/Desktop/new_outputs/modified/news/caksvm_data_duke_linear_barrier.csv',
    #     '/Users/shaozishan/Desktop/new_outputs/modified/news/caksvm_data_duke_poly_barrier.csv',
    #'/Users/shaozishan/Desktop/new_outputs/final_plots/Data/caksvm_data_mock2_gauss.csv',
    #'/Users/shaozishan/Desktop/new_outputs/final_plots/Data/caksvm_data_mock2_linear.csv',
    #'/Users/shaozishan/Desktop/new_outputs/final_plots/Data/caksvm_data_mock2_poly2.csv',
    #'/Users/shaozishan/Desktop/new_outputs/modified/news/caksvm_data_colon_gauss_barrier.csv',
    #'/Users/shaozishan/Desktop/new_outputs/modified/news/caksvm_data_colon_linear_barrier.csv',
    #'/Users/shaozishan/Desktop/new_outputs/modified/news/caksvm_data_colon_poly_barrier.csv']
...
for file in files:
    ...
    if 'duke' in file:
        directory = '/Users/shaozishan/Desktop/new_outputs/final_plots/HPCAsia/SVM/composition_plot/duke'
    elif 'mock' in file:
        directory = '/Users/shaozishan/Desktop/new_outputs/final_plots/HPCAsia/SVM/composition_plot/synthetic'
    elif 'colon' in file:
        directory = '/Users/shaozishan/Desktop/new_outputs/final_plots/HPCAsia/SVM/composition_plot/colon'
    elif 'newsbinary' in file:
        directory = '/Users/shaozishan/Desktop/new_outputs/final_plots/HPCAsia/SVM/composition_plot/newsbinary'
    else:
        directory = '/Users/shaozishan/Desktop/new_outputs/final_plots/HPCAsia/SVM/composition_plot'
    
    for blksize in unique_blksize:
        data = curr_data[curr_data['blksize'] == blksize]
        data = data[data['num_process'].isin([2,4,8,16,32,64,128,256,512,1024,2048])]
        ...
        for nump in unique_num_process_values: 
            ...
            filename = f'{data_type}_{kernel_type}_np{nump}_caksvm_Composition.pdf'
