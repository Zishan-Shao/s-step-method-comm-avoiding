...
# Load the dataset
df = pd.read_csv('/Users/shaozishan/Desktop/new_outputs/final_plots/Data/caksvm_data_newsbinary_linear_barrier.csv')
...
plt.rcParams.update({'font.size': 32}) # Set font size for all plot elements
fig, ax1 = plt.subplots(figsize=(20, 15))  # Adjust the width and height as needed
...
ax2.plot(adjusted_num_processes, major_time_s_0, color='g', marker='x', linestyle='--', label='DCD runtime', linewidth=3)
...
plot_title = 'DCD Strong Scaling (Max) | Newsbinary, Linear' 
...
directory = '/Users/shaozishan/Desktop/new_outputs/final_plots/SVM/general_plot'
